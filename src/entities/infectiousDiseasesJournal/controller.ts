...
const infectiousDiseasesJournalService = new InfectiousDiseasesJournalService();
...
export const getAllInfectiousDiseasesJournals = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await infectiousDiseasesJournalService.getAll({
...
export const getInfectiousDiseasesJournalById = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await infectiousDiseasesJournalService.getById(req.params.id);
    res.json(journal);
  } catch (err: any) {
...
export const createInfectiousDiseasesJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await infectiousDiseasesJournalService.create(req.body, req.user.id as string);
...
export const updateInfectiousDiseasesJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await infectiousDiseasesJournalService.update(req.params.id, req.body);
    res.json(journal);
  } catch (err: any) {
...
export const deleteInfectiousDiseasesJournal = async (req: Request, res: Response) => {
  try {
    ...
    const result = await infectiousDiseasesJournalService.delete(req.params.id);
    res.json(result);
  } catch (err: any) {
...
export const getInfectiousDiseasesJournalsByChildId = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await infectiousDiseasesJournalService.getByChildId(childId, {
      date: date as string,
      doctorId: doctorId as string,
      status: status as string,
      disease: disease as string,
...
export const getInfectiousDiseasesJournalsByDoctorId = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await infectiousDiseasesJournalService.getByDoctorId(doctorId, {
      childId: childId as string,
      status: status as string,
      disease: disease as string,
      startDate: startDate as string,
...
export const getUpcomingAppointments = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await infectiousDiseasesJournalService.getUpcomingAppointments(daysNum);
    res.json(journals);
  } catch (err: any) {
...
export const updateInfectiousDiseasesJournalStatus = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await infectiousDiseasesJournalService.updateStatus(req.params.id, status);
    res.json(journal);
  } catch (err: any) {
...
export const addInfectiousDiseasesJournalRecommendations = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await infectiousDiseasesJournalService.addRecommendations(req.params.id, recommendations);
    res.json(journal);
  } catch (err: any) {
...
export const getInfectiousDiseasesJournalStatistics = async (req: Request, res: Response) => {
  try {
    ...
    const stats = await infectiousDiseasesJournalService.getStatistics();
    res.json(stats);
  } catch (err: any) {
