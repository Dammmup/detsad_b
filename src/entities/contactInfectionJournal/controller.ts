...
const contactInfectionJournalService = new ContactInfectionJournalService();
...
export const getAllContactInfectionJournals = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await contactInfectionJournalService.getAll({
...
export const getContactInfectionJournalById = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await contactInfectionJournalService.getById(req.params.id);
    res.json(journal);
  } catch (err: any) {
...
export const createContactInfectionJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await contactInfectionJournalService.create(req.body, req.user.id as string);
...
export const updateContactInfectionJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await contactInfectionJournalService.update(req.params.id, req.body);
    res.json(journal);
  } catch (err: any) {
...
export const deleteContactInfectionJournal = async (req: Request, res: Response) => {
  try {
    ...
    const result = await contactInfectionJournalService.delete(req.params.id);
    res.json(result);
  } catch (err: any) {
...
export const getContactInfectionJournalsByChildId = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await contactInfectionJournalService.getByChildId(childId, {
      date: date as string,
      doctorId: doctorId as string,
      status: status as string,
      infectionType: infectionType as string,
...
export const getContactInfectionJournalsByDoctorId = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await contactInfectionJournalService.getByDoctorId(doctorId, {
      childId: childId as string,
      status: status as string,
      infectionType: infectionType as string,
      startDate: startDate as string,
...
export const getUpcomingAppointments = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await contactInfectionJournalService.getUpcomingAppointments(daysNum);
    res.json(journals);
  } catch (err: any) {
...
export const updateContactInfectionJournalStatus = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await contactInfectionJournalService.updateStatus(req.params.id, status);
    res.json(journal);
  } catch (err: any) {
...
export const addContactInfectionJournalRecommendations = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await contactInfectionJournalService.addRecommendations(req.params.id, recommendations);
    res.json(journal);
  } catch (err: any) {
...
export const traceContacts = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await contactInfectionJournalService.traceContacts(req.params.id);
    res.json(journal);
  } catch (err: any) {
...
export const getContactInfectionJournalStatistics = async (req: Request, res: Response) => {
  try {
    ...
    const stats = await contactInfectionJournalService.getStatistics();
    res.json(stats);
  } catch (err: any) {
