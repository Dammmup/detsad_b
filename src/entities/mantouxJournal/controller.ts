...
const mantouxJournalService = new MantouxJournalService();
...
export const getAllMantouxJournals = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await mantouxJournalService.getAll({
...
export const getMantouxJournalById = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await mantouxJournalService.getById(req.params.id);
    res.json(journal);
  } catch (err: any) {
...
export const createMantouxJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await mantouxJournalService.create(req.body, req.user.id as string);
...
export const updateMantouxJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await mantouxJournalService.update(req.params.id, req.body);
    res.json(journal);
  } catch (err: any) {
...
export const deleteMantouxJournal = async (req: Request, res: Response) => {
  try {
    ...
    const result = await mantouxJournalService.delete(req.params.id);
    res.json(result);
  } catch (err: any) {
...
export const getMantouxJournalsByChildId = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await mantouxJournalService.getByChildId(childId, {
      date: date as string,
      doctorId: doctorId as string,
      status: status as string,
      reactionType: reactionType as string,
...
export const getMantouxJournalsByDoctorId = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await mantouxJournalService.getByDoctorId(doctorId, {
      childId: childId as string,
      status: status as string,
      reactionType: reactionType as string,
      startDate: startDate as string,
...
export const getUpcomingAppointments = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await mantouxJournalService.getUpcomingAppointments(daysNum);
    res.json(journals);
  } catch (err: any) {
...
export const updateMantouxJournalStatus = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await mantouxJournalService.updateStatus(req.params.id, status);
    res.json(journal);
  } catch (err: any) {
...
export const addMantouxJournalRecommendations = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await mantouxJournalService.addRecommendations(req.params.id, recommendations);
    res.json(journal);
  } catch (err: any) {
...
export const getMantouxJournalStatistics = async (req: Request, res: Response) => {
  try {
    ...
    const stats = await mantouxJournalService.getStatistics();
    res.json(stats);
  } catch (err: any) {
