  ...
  try {
    ...
    switch (format) {
      case 'pdf':
        ...
        doc.text(`- Общие Вычеты: ${reportData.summary.totalPenalties} тг`);
        ...
        doc.text('Вычеты', 50 + colWidths[0] + colWidths[1] + colWidths[2], tableTop);
      ...
      case 'excel':
        ...
        const summaryWs = XLSX.utils.aoa_to_sheet([
          ...
          ['Общие Вычеты', reportData.summary.totalPenalties],
        ...
        const detailsData = [
          ['Сотрудник', 'Оклад', 'Премии', 'Вычеты', 'Итого', 'Статус', 'Период'],
      ...
      case 'csv':
        ...
        const csvHeader = 'Сотрудник,Оклад,Премии,Вычеты,Итого,Статус,Период\n';
