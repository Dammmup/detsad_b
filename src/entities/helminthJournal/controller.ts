...
const helminthJournalService = new HelminthJournalService();
...
export const getAllHelminthJournals = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await helminthJournalService.getAll({
...
export const getHelminthJournalById = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await helminthJournalService.getById(req.params.id);
    res.json(journal);
  } catch (err: any) {
...
export const createHelminthJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await helminthJournalService.create(req.body, req.user.id as string);
...
export const updateHelminthJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await helminthJournalService.update(req.params.id, req.body);
    res.json(journal);
  } catch (err: any) {
...
export const deleteHelminthJournal = async (req: Request, res: Response) => {
  try {
    ...
    const result = await helminthJournalService.delete(req.params.id);
    res.json(result);
  } catch (err: any) {
...
export const getHelminthJournalsByChildId = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await helminthJournalService.getByChildId(childId, {
      date: date as string,
      doctorId: doctorId as string,
      status: status as string,
      startDate: startDate as string,
...
export const getHelminthJournalsByDoctorId = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await helminthJournalService.getByDoctorId(doctorId, {
      childId: childId as string,
      status: status as string,
      startDate: startDate as string,
      endDate: endDate as string
...
export const getUpcomingAppointments = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await helminthJournalService.getUpcomingAppointments(daysNum);
    res.json(journals);
  } catch (err: any) {
...
export const updateHelminthJournalStatus = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await helminthJournalService.updateStatus(req.params.id, status);
    res.json(journal);
  } catch (err: any) {
...
export const addHelminthJournalRecommendations = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await helminthJournalService.addRecommendations(req.params.id, recommendations);
    res.json(journal);
  } catch (err: any) {
...
export const getHelminthJournalStatistics = async (req: Request, res: Response) => {
  try {
    ...
    const stats = await helminthJournalService.getStatistics();
    res.json(stats);
  } catch (err: any) {
