...
router.post('/', managerAuth, (req, res, next) => productPurchaseController.create(req, res, next));
router.delete('/:id', managerAuth, (req, res, next) => productPurchaseController.delete(req, res, next));
