...
const medicalJournalsService = new MedicalJournalsService();
...
export const getAllMedicalJournals = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await medicalJournalsService.getAll({
...
export const getMedicalJournalById = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await medicalJournalsService.getById(req.params.id);
    res.json(journal);
  } catch (err: any) {
...
export const createMedicalJournal = async (req: Request, res: Response) => {
  try {
    ...
    // Добавляем врача из аутентифицированного пользователя
    const journalData = {
      ...req.body,
      doctor: req.user.id
    };
    
    const journal = await medicalJournalsService.create(journalData);
...
export const updateMedicalJournal = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await medicalJournalsService.update(req.params.id, req.body);
    res.json(journal);
  } catch (err: any) {
...
export const deleteMedicalJournal = async (req: Request, res: Response) => {
  try {
    ...
    const result = await medicalJournalsService.delete(req.params.id);
    res.json(result);
  } catch (err: any) {
...
export const getMedicalJournalsByChildAndType = async (req: Request, res: Response) => {
  try {
    ...
    const journals = await medicalJournalsService.getByChildAndType(childId, type);
    res.json(journals);
  } catch (err: any) {
...
export const getUpcomingAppointments = async (req: Request, res: Response) => {
  try {
    ...
    const appointments = await medicalJournalsService.getUpcomingAppointments(daysNum);
...
export const updateMedicalJournalStatus = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await medicalJournalsService.updateStatus(req.params.id, status);
    res.json(journal);
  } catch (err: any) {
...
export const addMedicalJournalRecommendations = async (req: Request, res: Response) => {
  try {
    ...
    const journal = await medicalJournalsService.addRecommendations(req.params.id, recommendations);
    res.json(journal);
  } catch (err: any) {
...
export const getMedicalJournalsStatistics = async (req: Request, res: Response) => {
  try {
    ...
    const stats = await medicalJournalsService.getStatistics();
    res.json(stats);
  } catch (err: any) {
