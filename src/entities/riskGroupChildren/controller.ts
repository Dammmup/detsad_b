...
const riskGroupChildrenService = new RiskGroupChildrenService();
...
export const getAllRiskGroupChildren = async (req: Request, res: Response) => {
  try {
    ...
    const children = await riskGroupChildrenService.getAll({
...
export const getRiskGroupChildById = async (req: Request, res: Response) => {
  try {
    ...
    const child = await riskGroupChildrenService.getById(req.params.id);
    res.json(child);
  } catch (err: any) {
...
export const createRiskGroupChild = async (req: Request, res: Response) => {
  try {
    ...
    const child = await riskGroupChildrenService.create(req.body, req.user.id as string);
...
export const updateRiskGroupChild = async (req: Request, res: Response) => {
  try {
    ...
    const child = await riskGroupChildrenService.update(req.params.id, req.body);
    res.json(child);
  } catch (err: any) {
...
export const deleteRiskGroupChild = async (req: Request, res: Response) => {
  try {
    ...
    const result = await riskGroupChildrenService.delete(req.params.id);
    res.json(result);
  } catch (err: any) {
...
export const getRiskGroupChildrenByChildId = async (req: Request, res: Response) => {
  try {
    ...
    const children = await riskGroupChildrenService.getByChildId(childId, {
      date: date as string,
      doctorId: doctorId as string,
      status: status as string,
      riskFactor: riskFactor as string,
...
export const getRiskGroupChildrenByDoctorId = async (req: Request, res: Response) => {
  try {
    ...
    const children = await riskGroupChildrenService.getByDoctorId(doctorId, {
      childId: childId as string,
      status: status as string,
      riskFactor: riskFactor as string,
      startDate: startDate as string,
...
export const getUpcomingAssessments = async (req: Request, res: Response) => {
  try {
    ...
    const children = await riskGroupChildrenService.getUpcomingAssessments(daysNum);
    res.json(children);
  } catch (err: any) {
...
export const updateRiskGroupChildStatus = async (req: Request, res: Response) => {
  try {
    ...
    const child = await riskGroupChildrenService.updateStatus(req.params.id, status);
    res.json(child);
  } catch (err: any) {
...
export const addRiskGroupChildRecommendations = async (req: Request, res: Response) => {
  try {
    ...
    const child = await riskGroupChildrenService.addRecommendations(req.params.id, recommendations);
    res.json(child);
  } catch (err: any) {
...
export const getRiskGroupChildStatistics = async (req: Request, res: Response) => {
  try {
    ...
    const stats = await riskGroupChildrenService.getStatistics();
    res.json(stats);
  } catch (err: any) {
